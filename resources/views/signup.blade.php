        ...
        <section
            ...
            <div class="p-6 sm:p-8" x-data="{ role: 'student', showPassword: false, showConfirm: false }">
                ...
                <div class="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white/90 p-6 sm:p-8 shadow-sm">
                    <!-- Profile Photo Upload (Click + to add image) -->
                    <div x-data="{ imageUrl: null }" class="text-center">

                        <!-- Clickable Circle -->
                        <div @click="$refs.fileInput.click()"
                            class="mx-auto w-24 h-24 rounded-full border-2 border-sky-200 bg-sky-50 grid place-items-center text-sky-700 font-bold text-2xl cursor-pointer overflow-hidden">
                        ...
                        <!-- Hidden File Input -->
                        <input type="file" name="profile_photo" accept="image/*" class="hidden" x-ref="fileInput"
                            @change="
        ...
        ">
                    ...
                    <form class="mt-6 grid gap-4" action="#" method="POST">
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                <label for="name" class="block text-sm font-medium text-slate-700 mb-1.5">Full
                                    Name</label>
