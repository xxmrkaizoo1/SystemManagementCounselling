                ...
                <div class="p-6 sm:p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-slate-200/80">
                    ...
                    <div class="mt-6 rounded-2xl border border-slate-200 bg-white/80 p-6">
                        ...
                        <p class="mt-3 text-sm text-slate-600 leading-relaxed">
                            No worries. Enter your email and we’ll send a secure reset link so you can create a new
                            password.
                        </p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}" class="mt-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                    autofocus placeholder="name@college.edu"
                            ...
                            <p class="text-center text-sm text-slate-500">
                                ...
                                <a href="{{ route('login') }}" class="font-medium text-sky-700 hover:text-sky-800">Back
                                    to login</a>
                            </p>
                        </form>
                    </div>
