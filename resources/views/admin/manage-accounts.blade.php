...
<head>
    ...
    <style>
        ...
        @keyframes pulse-glow {
            ...
            0%,
            100% {
                box-shadow: 0 0 0 0 rgba(14, 116, 144, 0.18);
            }

            50% {
                box-shadow: 0 0 0 8px rgba(14, 116, 144, 0.02);
            }
        }
        ...
        .animate-slide-up-fade {
            animation: slide-up-fade 650ms cubic-bezier(.2, .7, .2, 1) both;
        }
...
<body class="min-h-screen bg-slate-50 text-slate-700 overflow-x-hidden">
    <div class="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
        ...
        <div
            class="absolute -top-24 -left-16 w-[30rem] h-[30rem] bg-sky-300/30 rounded-full blur-3xl animate-float-soft">
        </div>
        <div class="absolute top-24 -right-24 w-[30rem] h-[30rem] bg-emerald-300/25 rounded-full blur-3xl animate-float-soft"
        ...
        <section
            ...
            <div class="p-6 sm:p-7 space-y-5">
                ...
                <div class="space-y-4">
                    ...
                    <article class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm animate-pulse-glow">
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody id="managed_users_table">
                                    @forelse ($managedUsers as $managedUser)
                                        <tr class="border-b border-slate-100 managed-user-row cursor-pointer hover:bg-sky-50/70 transition"
                ...
                <form id="edit_user_form" method="POST" class="mt-5 space-y-3"
                    ...
                    <div>
                        <label for="edit_user_name"
                            class="block text-sm font-medium text-slate-700 mb-1.5">Nama</label>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const openModalWithUser = (row) => {
                ...
                if (deleteUserButton) {
                    ...
                    deleteUserButton.textContent = isOwnAccount ? 'Tidak boleh padam akaun sendiri' :
                        'Padam Pengguna';
                }
