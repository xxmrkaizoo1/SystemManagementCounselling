        ...
        <section
            ...
            <header
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" id="sidebar-toggle" aria-controls="booking-sidebar" aria-expanded="false"
            ...
            <div class="p-5 sm:p-7 page-shell">
                <aside id="booking-sidebar"
                    class="booking-sidebar rounded-2xl border border-sky-100 bg-sky-100/60 p-4 shadow-sm">
